...
class FlickrAPIService {
    class func fetchImages(page: Int, completion: @escaping (_ fetchSuccessful: Bool, _ fetchedImages: [FlickrURLs])->()) {
        ...
        let flickrURL = "https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=6343a66eb46c461c91934e8a7a981056&text=flowers&format=json&nojsoncallback=1"
